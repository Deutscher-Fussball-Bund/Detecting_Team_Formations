...
def draw_pitch(ax):
    ...
    leftArc = Arc((9.7, 40), height=16.2, width=16.2, angle=0,
                  theta1=310, theta2=50, color="black")
    rightArc = Arc((110.3, 40), height=16.2, width=16.2,
...
def draw_positions(array):
    fig = plt.figure()
    fig.set_size_inches(7, 5)
    ax = fig.add_subplot(1, 1, 1)
    draw_pitch(ax)
    for player in array:
        ax.annotate(player[0], xy=player[1], xycoords='data', xytext=player[2], textcoords='data',

...
from start_analysis import start_analysis,start_clustering_matches,start_clustering_match,start_clustering_team
...
clusters_matches=start_clustering_team(path_GER_NL,info_path_GER_NL,'DFL-CLU-000N99')
for cluster in clusters_matches:
    elbow(cluster)
    silhouette(cluster)
